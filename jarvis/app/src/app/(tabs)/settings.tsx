...
const LISTEN_MODES = [
  { mode: "wake", label: "Wake word", hint: "Say the assistant's name while the Assistant tab is open." },
  {
    mode: "twist",
    label: "Clip click",
    hint: "Double-click the OVOA Band's button: it buzzes and listens. Press once to send what you said; press once while it answers to cut it off. Works from other apps too.",
  },
] as const;
